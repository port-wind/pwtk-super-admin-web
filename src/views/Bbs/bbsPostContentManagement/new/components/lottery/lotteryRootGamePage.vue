...
import {
  useLotteryParticipationLogic,
  type BallOption,
  type PlayRuleExtended
} from '@/views/Bbs/bbsPostContentManagement/new/components/lottery/useLotteryParticipationLogic'
...
function onRuleSelectionChanged(rule: PlayRuleExtended, selectedBalls: BallOption[]): void {
  console.log('onRuleSelectionChanged', rule, selectedBalls)
  // console.log(getLotteryPredictionsFrom(showingRules.value))
