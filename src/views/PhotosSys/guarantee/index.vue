...
import { useGuaranteeApi } from '@/api/photoSys/guarantee/index'
...
const { list, create, edit, del, existSiteId, existSiteName, getListBlurSiteId, getListBlurSiteName } =
  useGuaranteeApi(manageSiteId)
