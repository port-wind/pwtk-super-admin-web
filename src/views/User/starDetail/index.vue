...
import { reqPointActivityList, reqStarRulesDetail } from '@/api/user/pointRules'
...
onMounted(async () => {
  try {
    const res: any = await reqPointActivityList() // Change this function name if necessary
    const data = res.data
