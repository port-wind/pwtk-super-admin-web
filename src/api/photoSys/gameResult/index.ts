...
interface InsertSettleCheckQueryParams {
  /**
   * 期数
...
export const updateSettleCheck = (
  gameTypeCode: string,
  data: InsertSettleCheckQueryParams
  ...
  // type Tab = 'a6' | 'hk6' | 'sg6' | 'tw6' | 'xa6' | 'kl8'
  // webgw/game/type/a6/insertDoubleCheck
  // webgw/game/type/hk6/insertDoubleCheck
  // webgw/game/type/sg6/insertDoubleCheck
  // webgw/game/type/tw6/insertDoubleCheck
  ...
  const path = gameMap[gameTypeCode]

  return http.post(`webgw/game/type/${path}/insertDoubleCheck`, {
    ...data,
