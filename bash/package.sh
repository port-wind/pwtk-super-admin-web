...
info_message "Generating webConfigApi.js..."

# Generate webConfigApi.js
npm run generate-config || error_exit "Failed to generate webConfigApi.js"

# Verify the config file was generated
if [ ! -f "public/webConfigApi.js" ]; then
    error_exit "webConfigApi.js was not generated in public directory"
fi
